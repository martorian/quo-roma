...
export function Proposal({ proposal }: Props) {
    ...
    const [descriptionModalOpened, setDescriptionModalOpened] =
    ...
    return (
        <UI.Card className="w-full relative overflow-hidden">
            <UI.CardHeader className="flex flex-row items-center gap-4 -my-3 space-y-0">
                ...
                <div className="absolute top-0 left-0 w-1 h-full flex flex-col gap-[1px] rounded-lg">
                    <div
                        className="block w-full bg-gradient-to-b from-green-500"
                        style={{ height: `${(100 * yesVotes) / totalVotes}%` }}
                    />
                    <div
                        className="block w-full bg-gradient-to-t from-red-500"
                        style={{ height: `${(100 * noVotes) / totalVotes}%` }}
                    />
                </div>
